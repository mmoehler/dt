...
public class ObservableList2DFunctionsTest {
    ...
    public void testReplaceColumn() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,?,C,D,E,A,B,?,C,D,E,A,B,?,C,D,E").dim(3, 6).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,B,X,C,D,E,A,B,Y,C,D,E,A,B,Z,C,D,E").dim(3, 6).build());
    ...
    public void testInsertColumn() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,B,?,C,D,E,A,B,?,C,D,E,A,B,?,C,D,E").dim(3, 6).build());
    ...
    public void testRemoveColumn() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,B,D,E,A,B,D,E,A,B,D,E").dim(3, 4).build());
    ...
    public void testTranspose() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,A,A,B,B,B,C,C,C,D,D,D,E,E,E").dim(5, 3).build());
    ...
    public void testMoveColumnOldPosLWNewPos() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,C,D,B,E,A,C,D,B,E,A,C,D,B,E").dim(3, 5).build());
    ...
    public void testMoveColumnOldPosGTNewPos() throws Exception {
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,C,D,B,E,A,C,D,B,E,A,C,D,B,E").dim(3, 5).build());
    ...
    public void testAddRow() throws Exception {
        ObservableList<ObservableList<String>> input = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E").dim(3, 5).build());
        ObservableList<ObservableList<String>> expected = observable(MatrixBuilder.matrixOf("A,B,C,D,E,A,B,C,D,E,A,B,C,D,E,?,?,?,?,?").dim(4, 5).build());
