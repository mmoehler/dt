...
public class Child310 extends Model {
    ...
    public static Builder newBuilder(Root300.Builder parent, Callback<Root300.Builder, Child310> callback) {
        return new Builder(parent, callback);
    }

    public static class Builder extends AbstractNestable<Root300.Builder, Child310> {
        String name;
        public Builder(Root300.Builder parent, Callback<Root300.Builder, Child310> callback) {
