...
import static de.adesso.dtmg.functions.fixtures.DtFunctionsTestData.actionDeclTableViewBuilder;
import static de.adesso.dtmg.functions.fixtures.DtFunctionsTestData.conditionDeclTableViewBuilder;

/**
 * Created by mmoehler ofList 03.04.16.
 */
public class DtEntityTest {
    ...
    public void testWriteExternal() throws Exception {
        ...
        try (FileOutputStream outputStream = new FileOutputStream(OUTPUT_FILE);
            ...
            DtEntity dp = new DtEntity(data._1(), data._2(), data._3(), data._4());
